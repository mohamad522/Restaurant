  ...
  return(
    <Media className='row mt-5'>
      ...
      <Media body className='col-9 ml-5'>
        ...
        <Media middle>{leader.designation}</Media><br />
        {leader.description}
      </Media>
    </Media>    
  )
        ...
        <div className="container">
            ...
            <div className="row row-content">
                <div className="col-12 col-md-6">
                    ...
                    <p>The restaurant traces its humble beginnings to <em>The Frying Pan</em>, a successful 
                    chain started by our CEO, Mr. Peter Pan, that featured for the first time the world's best 
                    cuisines in a pan.</p>
                </div>
